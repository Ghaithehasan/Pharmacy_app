...
@section('content')
				...
				<div class="row row-sm">
					...
					<div class="col-xl-4 col-md-12 col-lg-6">
						<div class="card">
							<div class="card-header pb-1">
								<h3 class="card-title mb-2">{{ $supplier->contact_person_name}}</h3>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                ...
                <p class="mg-b-0">نقدم لك برنامج لأدارة الفواتير - المطور غيث ابراهيم حسن</p>
            </div>
        </div>
        <div class="main-dashboard-header-right">
            <div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7"> عدد الفواتير الاجمالية {{ App\Models\Invoices::count() }} </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7"> عدد الفواتير غير المدفوعة {{ App\Models\Invoices::where('Value_Status', 2)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
    ...
    <script>
        ...
        var myPieChart = new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                    data: [{{ App\Models\Invoices::where('Value_Status', 1)->count() }}, {{ App\Models\Invoices::where('Value_Status', 2)->count() }}, {{ App\Models\Invoices::where('Value_Status', 3)->count() }}],
